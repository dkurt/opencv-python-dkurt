...
def main():
    ...
    package_name = "opencv-python-dkurt"

    if build_contrib and not build_headless:
        package_name = "opencv-contrib-python-dkurt"

    if build_contrib and build_headless:
        package_name = "opencv-contrib-python-headless-dkurt"

    if build_headless and not build_contrib:
        package_name = "opencv-python-headless-dkurt"
